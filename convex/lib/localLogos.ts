/**
 * Mapping of known club names to locally hosted logo paths.
 * Keys are lowercase club name prefixes matched via startsWith.
 * Longer keys listed first to avoid false prefix matches.
 */
 ...
 * Matches the start of the name against known club keys.
 */
