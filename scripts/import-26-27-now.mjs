/**
 * One-off: import docs/Teamindelingen_26-27.csv into Convex prod.
 * Never writes JO13-2. Names are already Firstname Lastname (--as-is).
 */
...
function convexRun(functionName, args) {
  try {
    ...
    throw new Error(raw.replace(/opsSecret":\s*"[^"]+"/g, 'opsSecret":"***"').slice(0, 500));
  }
}
...
console.log(`Import ${slugs.length} teams, skip JO13-2`);
