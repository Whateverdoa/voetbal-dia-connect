...
export function ScoreDisplay({
  ...
  return (
    <div className="bg-dia-black text-white p-4 sm:p-6">
      <div className="max-w-2xl mx-auto">
        {/* Top row: public code and status */}
        <div className="flex items-center justify-between mb-4">
          <span className="font-mono text-sm bg-white/15 text-white px-2 py-1 rounded">
            {publicCode}
          </span>
        ...
        {scheduledAt != null && (
          <p
            className={`text-center text-sm text-white/80 tabular-nums ${
        ...
        {isHome && venueField ? (
          <p className="text-center text-sm text-white/75 mb-3">{venueField}</p>
        ) : null}
