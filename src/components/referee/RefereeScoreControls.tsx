    ...
    <div className="flex flex-col items-center gap-2">
      ...
      <div className="flex gap-2 w-full">
        ...
        <button
          ...
          disabled={isLoading}
          className="flex-1 py-3 bg-dia-green text-white text-xl font-bold rounded-lg min-h-[48px] active:scale-[0.96] transition-transform hover:bg-dia-green-dark disabled:opacity-50"
          aria-label={`${teamName} score +1`}
        >
          +
        </button>
