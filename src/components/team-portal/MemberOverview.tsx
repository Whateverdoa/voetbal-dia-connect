      ...
      <div className="grid gap-5 md:grid-cols-2">
        <section className={panelClass} aria-labelledby="next-fixture">
          ...
          <div className="mt-4 flex items-center gap-4">
            ...
            <div><p className="font-bold text-stone-900">DIA JO13 – Parkstad JO13</p><p className="mt-1 text-sm text-stone-500">Zaterdag · 10:30 uur</p><p className="mt-1 text-xs text-stone-400">Oefenwedstrijd · fictief programma</p></div>
          </div>
        </section>
        <section className={panelClass} aria-labelledby="last-fixture">
          ...
          {lastMatch ? <div className="mt-5 flex items-center justify-between gap-4"><div><p className="font-bold text-stone-900">DIA JO13 – {lastMatch.opponent}</p><p className="mt-2 text-sm text-stone-500">{lastMatch.dateLabel}</p></div><p className="shrink-0 rounded-xl bg-stone-100 px-4 py-3 text-2xl font-black tracking-tight text-stone-900">{lastMatch.score}</p></div> : <p className="mt-4 text-sm text-stone-500">Er is nog geen wedstrijd gespeeld.</p>}
        </section>
      </div>
