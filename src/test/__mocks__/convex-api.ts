...
export const api = {
  matches: {
    ...
    listActiveReferees: "matches:listActiveReferees",
    getCoachTeamSetup: "matches:getCoachTeamSetup",
  },
  admin: {
    verifyAdminAccessQuery: "admin:verifyAdminAccessQuery",
    getClubBySlug: "admin:getClubBySlug",
    createClub: "admin:createClub",
    listClubs: "admin:listClubs",
    createTeam: "admin:createTeam",
    updateTeam: "admin:updateTeam",
    deleteTeam: "admin:deleteTeam",
    listTeamsByClub: "admin:listTeamsByClub",
    listAllTeams: "admin:listAllTeams",
    ...
    createReferee: "admin:createReferee",
    listReferees: "admin:listReferees",
    updateReferee: "admin:updateReferee",
    deleteReferee: "admin:deleteReferee",
    createMatch: "admin:createMatch",
    updateMatch: "admin:updateMatch",
    deleteMatch: "admin:deleteMatch",
    addPlayerToMatch: "admin:addPlayerToMatch",
    createPlayerAndAddToMatch: "admin:createPlayerAndAddToMatch",
    listAllMatches: "admin:listAllMatches",
    listAssignmentBoard: "admin:listAssignmentBoard",
    listTeamPlayersNotInMatch: "admin:listTeamPlayersNotInMatch",
  },
  teams: {
